...
KAFKA_TOPIC = "stream-twitter-events"
flink_group = "flink_group"
SINK_DIR = "/home/cloud_user/kafka-3/py-hadoop-flink/flink"
...
#    env.add_jars("file:///home/cloud_user/kafka-3/pyflink/flink-sql-connector-kafka-3.4.0-1.20.jar")
...
#    output_path = os.path.join(os.environ.get('/home/cloud_user/kafka-3/pyflink/flink', "/sink"), "sink.log")
    output_path = "/home/cloud_user/kafka-3/pyflink/flink/sink"
